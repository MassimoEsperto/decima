...
$sql_giornate .="fine_giornata,serie_a,is_upgrade,turno_id ";
...
if($result = mysqli_query($con,$sql_giornate))
{
	...
	{
		$giornate_[$ele]['giornata'] = (int)$row['id_giornata'];
		$giornate_[$ele]['turno'] = (int)$row['turno_id'];
        $giornate_[$ele]['serie_a'] = (int)$row['serie_a'];
